<template>
  ...
  <div class="ham-menu">
    <ul class="centre-text bold-text">
      <li><RouterLink class="motext" to="/">Home</RouterLink></li>
      <li>test</li>
      <li>test</li>
      <li>test</li>
      <li>test</li>
